...
?>
  ...
  <style>
    ...
    td {
      text-align: left;
      padding: 8px;
      border-bottom: 1px solid #090945;
      /* Garis antara baris */
    }
    ...
    .popup-menu {
      ...
      /* Transisi untuk efek keluar masuk */
      background-color: rgba(27, 27, 45, 0.9);
      /* Latar belakang semi transparan */
      z-index: 9999;
      /* Menempatkan popup di atas elemen lain */
    }
    ...
    ul li.submenu::before {
      content: '\203A';
      /* kode unicode untuk simbol panah ke kanan */
      position: absolute;
      left: 0;
    }
