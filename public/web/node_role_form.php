...
<?php  
  ...
  $sURL_Action = "../web/fungsi/addNodeRole1"; 
  $btnCap = "Tambah";
  $id_role=0;
  $repeater = 0;
  $id_memo = 0;
  ...
  if(isset($_GET['nrid'])) {
    $id_role = $_GET['nrid'];
    $sURL_Action = "../web/fungsi/updateNodeRole1"; 
    $btnCap = "Update";
...
<form action="<?=$sURL_Action?>" method="post">
  ...
  <table>
    ...
    <input type="text" id="keterangan" value="<?=$keterangan;?>"  name="keterangan"  title="Keterangan Role" required></td></tr> 
    ...
    <tr><td><label for="relay">relay</label></td><td><input type="number"  value=<?=$relay;?> id="relay" name="relay" required></td></tr> 
    <tr><td><label for="exeval">Exe Val:</label></td><td><input type="number" value=<?=$exeval;?> id="exeval" name="exeval" required></td></tr>   
    <tr><td><label for="val1">Value 1:</label></td><td><input type="number" value=<?=$exe_v1;?> id="val1" name="val1"  ></td></tr> 
    <tr><td><label for="val2">Value 2:</label></td><td><input type="number" value=<?=$exe_v2;?> id="val2" name="val2"  ></td></tr> 
    
    <tr><td><label for="reff_node">reff_node</label></td><td><input type="number" value=<?=$reff_node;?> id="reff_node" name="reff_node"  ></td></tr> 
    <tr><td><label for="nilai_1">nilai_1</label></td><td><input type="number" value=<?=$nilai_1;?> id="nilai_1" name="nilai_1"  ></td></tr> 
    ...
    <tr><td><label for="memo">Memo : </label></td><td><textarea id="memo"  name="memo" maxlength="2000" style="height:auto;" ><?=$memo;?></textarea></td></tr> 
  </table>  
  <div class="center-button">
    <input type="submit" value="<?=$btnCap?>" class="btn-submit">
  </div>
</form> 
<!-- Popup  Form -->
