      ...
      <div class="card-body">  
          ...
          <div class="row"> 
            <div class="col-md-4">
              ...
              <select name="tangki_id" class="form-control">
                ...
                <?php
                $sql_bahan = "SELECT b.id,b.nama,b.deskripsi,b.kelarutan, g.max_kelarutan, g.saran_stok FROM nut_bahan b JOIN nut_generic g ON g.id=b.generic_id ORDER BY id";
                bikinOption($sql_bahan,$tangki_id,"nama"," ","deskripsi", " <= ", "max_kelarutan" ," gr/liter");
                ?>
              </select>
              </div>
            </div>
            ...
            <div class="col-md-2"> 
              <div class="form-group">
                ...
                <?php if($is_edit): ?>
                  ...
                  <a href="nd_tangki" class="btn btn-secondary" title="batal/cancel">X</a>
        ...
        <table id="tbl" class="table table-bordered table-striped">
         ...
         $sql = "SELECT k.id,t.nama AS tangki,
                ...
                k.konsentrasi_stok,
                b.deskripsi
          FROM nut_tangki_komposisi k
          JOIN nut_tangki t ON k.tangki_id = t.id
          JOIN nut_bahan b ON k.bahan_id = b.id";
